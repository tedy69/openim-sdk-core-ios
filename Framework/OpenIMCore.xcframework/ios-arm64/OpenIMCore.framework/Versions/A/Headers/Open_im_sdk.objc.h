// Objective-C API for talking to bitbucket.org/interdigital/aka-im-sdk-core/open_im_sdk Go package.
//   gobind -lang=objc bitbucket.org/interdigital/aka-im-sdk-core/open_im_sdk
//
